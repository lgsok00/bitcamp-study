<%@ page language="java" pageEncoding="UTF-8"
         ...
         trimDirectiveWhitespaces="true" %> <%-- directive elememt --%>
...
<form action='/member/update.jsp' method='post' enctype='multipart/form-data'>
  <table border='1'>
    <tr>
      ...
      <td style='width:300px;'>
        <%=member.getPhoto() == null ? "<img style='height:80px' src='/images/avatar.png'>" :
                String.format("<a href='https://kr.object.ncloudstorage.com/bitcamp-nc7-bucket-30/member/%s'>"
                        + "<img src='http://jzawvdvdsitq19010738.cdn.ntruss.com/member/%1$s?type=f&w=60&h=80&faceopt=true&ttype=jpg'>"
                        + "</a>", member.getPhoto())%>
    ...
    <tr>
      ...
      <td style='width:300px;'><input type='text' name='no' value='<%=member.getNo()%>' readonly>
      </td>
    </tr>
    <tr>
      <th>이름</th>
