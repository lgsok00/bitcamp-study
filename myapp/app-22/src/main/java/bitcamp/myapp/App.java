...
import bitcamp.myapp.controller.BoardHandler;
import bitcamp.myapp.controller.Handler;
...
public class App {
  ...
  public static void main(String[] args) {
    ...
    Handler memberHandler = new MemberHandler(prompt, "회원", new ArrayList()); // 의존 객체를 생성자를 통해 주입
